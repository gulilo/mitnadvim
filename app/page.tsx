...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-200 border-1 rounded-lg m-6">
      ...
      {session?.user ? (
        <h1 className="text-2xl md:text-4xl">welcome {session.user.name}</h1>
      ) : (
